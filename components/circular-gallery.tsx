  ...
  createShader() {
    ...
    this.program = new Program(this.gl, {
      ...
      fragment: `
        ...
        void main() {
          vec2 ratio = vec2(
            min((uPlaneSizes.x / uImageSizes.x), (uPlaneSizes.y / uImageSizes.y)),
            min((uPlaneSizes.y / uImageSizes.y), (uPlaneSizes.x / uImageSizes.x))
          );
          vec2 uv = vec2(
...
export default function CircularGallery({
  ...
  font = "bold 30px Figtree",
  onInitialized = () => {},
}: CircularGalleryProps & { onInitialized?: (controls: GalleryControls) => void }) {
